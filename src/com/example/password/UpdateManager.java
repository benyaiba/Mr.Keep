...
import android.util.Log;
     ...
     public static final String UPDATE_DOWNURL = "http://geekboys.oicp.net:800/dafans/etc/keep.apk";
     public static final String UPDATE_CHECKURL = "http://geekboys.oicp.net:800/dafans/etc/keep_update.txt";
